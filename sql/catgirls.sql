...
--
-- 转存表中的数据 `cg_auth_rule`
--

INSERT INTO `cg_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
--
-- 表的结构 `cg_common_action_log`
--

CREATE TABLE `cg_common_action_log` (
  `id` int(11) NOT NULL,
...
INSERT INTO `cg_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
...
INSERT INTO `cg_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
INSERT INTO `cg_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
INSERT INTO `cg_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
(6, 'site_options', '            {\r\n            		"site_name":"猫女CatGirls",\r\n            		"site_host":"http://localhost/maonv/",\r\n            		"site_root":"",\r\n            		"site_icp":"",\r\n            		"site_admin_email":"1811128205@qq.com",\r\n            		"site_tongji":"",\r\n            		"site_copyright":"",\r\n            		"site_seo_title":"猫女CatGirls",\r\n            		"site_seo_keywords":"CatGirls,猫女,时尚,杂志",\r\n            		"site_seo_description":"ThinkCMF是简约风网络科技发布的一款用于快速开发的内容管理框架"\r\n        }', 1);
...
INSERT INTO `cg_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
--
-- 表的结构 `cg_term_relationships`
--

CREATE TABLE `cg_term_relationships` (
...
--
-- 表的结构 `cg_user_favorites`
--

CREATE TABLE `cg_user_favorites` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `cg_auth_access`
--
ALTER TABLE `cg_auth_access`
  ADD KEY `role_id` (`role_id`),
  ADD KEY `rule_name` (`rule_name`) USING BTREE;

--
-- Indexes for table `cg_auth_rule`
--
...
--
-- Indexes for table `cg_comments`
--
ALTER TABLE `cg_comments`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cg_common_action_log`
--
ALTER TABLE `cg_common_action_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_object_action` (`user`,`object`,`action`),
  ADD KEY `user_object_action_ip` (`user`,`object`,`action`,`ip`);

--
-- Indexes for table `cg_guestbook`
--
ALTER TABLE `cg_guestbook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cg_links`
--
ALTER TABLE `cg_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `link_visible` (`link_status`);

--
-- Indexes for table `cg_menu`
--
ALTER TABLE `cg_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cg_nav`
--
ALTER TABLE `cg_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cg_nav_cat`
--
ALTER TABLE `cg_nav_cat`
  ADD PRIMARY KEY (`navcid`);

--
-- Indexes for table `cg_oauth_user`
--
ALTER TABLE `cg_oauth_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cg_options`
--
ALTER TABLE `cg_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `cg_plugins`
--
ALTER TABLE `cg_plugins`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cg_posts`
--
...
--
-- Indexes for table `cg_route`
--
ALTER TABLE `cg_route`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cg_slide`
--
...
--
-- Indexes for table `cg_slide_cat`
--
...
--
-- Indexes for table `cg_terms`
--
ALTER TABLE `cg_terms`
  ADD PRIMARY KEY (`term_id`);

--
-- Indexes for table `cg_term_relationships`
--
...
--
-- Indexes for table `cg_user_favorites`
--
ALTER TABLE `cg_user_favorites`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uid` (`uid`);
...
--
ALTER TABLE `cg_auth_rule`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键', AUTO_INCREMENT=174;
--
...
--
-- 使用表AUTO_INCREMENT `cg_common_action_log`
--
ALTER TABLE `cg_common_action_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `cg_guestbook`
--
ALTER TABLE `cg_guestbook`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `cg_links`
--
ALTER TABLE `cg_links`
